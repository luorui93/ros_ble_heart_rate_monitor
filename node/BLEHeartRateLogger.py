...
class BLEHeartRateLogger:
    ...
    def insert_db(self, sq, res, period, min_ce=2, max_ce=60 * 2, grace_commit=2 / 3.):
        """
    ...
    def main(self, addr=None, sqlfile=None, gatttool="gatttool", check_battery=False, hr_handle=None, hr_ctl_handle=None, debug_gatttool=False):
        """
        ...
        while not rospy.is_shutdown():
            ...
            while 1:
                rospy.loginfo("Establishing connection to " + addr)
            ...
            if hr_handle == None and hr_ctl_handle == None:
                ...
                rospy.loginfo("Querying the handle...")
                ...
                while 1:
                    try:
                        ...
                        rospy.logerror("Querying handle reached timeout.")
                        break
                ...
                if hr_handle == None:
                    rospy.logerror("Couldn't find the heart rate measurement handle.")
                    return
            ...
            while not rospy.is_shutdown():
                try:
                    ...
                    rospy.loginfo("Received keyboard interrupt. Quitting cleanly.")
                    retry = False
                    break
    ...
    def cli(self):
        ...
        # self.main(args.m, args.o, args.g, args.b, args.H, args.C, args.d)
        self.main(addr=self.mac, hr_handle=self.hr_handle, hr_ctl_handle=self.hr_ctl_handle)
